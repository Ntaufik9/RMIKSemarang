...
class PostController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        if ($cat) {
            return redirect('admin/post')->with('status', 'Sukses menambah data Bes!');
        }

        return redirect('admin/post')->with('status', 'Gagal menambah data Bes!');
    }
    ...
    public function delete($id)
    {
        ...
        $delete = $data->delete();
        if ($delete) {
            return redirect('admin/post')->with('status', 'Berhasil hapus post bestie!');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($data) {
            return redirect('admin/post')->with('status', 'Post berhasil diedit bestie!');
        }
