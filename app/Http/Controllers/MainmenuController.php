...
class MainmenuController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        if ($cat) {
            return redirect('admin/mainmenu')->with('status', 'Berhasil menambah data bess!');
        }
    ...
    public function delete($id)
    {
        ...
        $delete = $data->delete();
        if ($delete) {
            return redirect('admin/mainmenu')->with('status', 'Berhasil hapus mainmenu bestie !');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($data) {
            return redirect('admin/mainmenu')->with('status', 'mainmenu berhasil diedit besss!');
        }
