...
class CategoriesController extends Controller
{
   ...
   public function insert(Request $request)
   {
       ...
       if($cat){
           return redirect('admin/category')->with('status', 'Sukses Bestie !');
       }

       return redirect('admin/category')->with('status', 'Gagal Bestie !');
   }
   public function delete($id)
   {
       ...
       $delete = $data->delete();
       if ($delete) {
           return redirect('admin/category')->with('status', 'Berhasil Bestie !');
       }
       return redirect('admin/category')->with('status', 'Gagal Bestie!');
    }
    ...
    if ($data) {
        return redirect('admin/category')->with('status', 'Berhasil diedit Bestie !');
    }
    return redirect('admin/category')->with('status', 'Gagal edit Bestie !');
    }
