...
class SliderController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        if ($cat) {
            return redirect('admin/slider')->with('status', 'Berhasil menambah data Bestie !');
        }

        return redirect('admin/slider')->with('status', 'Gagal menambah data Bestie !');
    }
    ...
    public function delete($id)
    {
        ...
        $delete = $data->delete();
        if ($delete) {
            return redirect('admin/slider')->with('status', 'Berhasil hapus Bestie !');
        }
        return redirect('admin/slider')->with('status', 'Gagal hapus Bestie !');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($data) {
            return redirect('admin/slider')->with('status', 'Slider sukses diedit bestie !');
        }
        return redirect('admin/slider')->with('status', 'Gagal edit slider bestie !');
    }
}
